...
$ideas       = $this->getSetting( 'openai_post_ideas', array() );
	...
	<table class="form-table" role="presentation">
		<tbody>
			...
			echo $this->formField(
				array(
					'type'        => 'number',
					'name'        => 'knowledgebase_posts_count',
					'label'       => 'Existing Posts to Analyze',
					'description' => esc_html__( 'Specify the number of existing posts to include as the knowledge base for generating new post ideas. A larger number provides more context for the AI but may increase processing time.' ),
					'required'    => true,
			...
			echo $this->formField(
				array(
					'type'        => 'number',
					'name'        => 'idea_posts_count',
					'label'       => 'Post Ideas to Generate',
					'description' => esc_html__( 'Enter the number of post ideas you want the AI to generate.' ),
					'required'    => true,
